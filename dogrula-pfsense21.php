...
// Doğrulama komutu
exec('/usr/local/bin/openssl ts -config /logimza/.openssl/openssl.cnf -verify -data /tmp/' . $log_type . '.log -in /tmp/' . $log_type . '.log.der -token_in -CAfile /logimza/.openssl/CA/cacert.pem -untrusted /logimza/.openssl/CA/tsacert.pem', $result);
